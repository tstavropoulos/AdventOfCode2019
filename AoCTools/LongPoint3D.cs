...
namespace AoCTools
{
    public readonly struct LongPoint3D
    {
        ...
        public readonly long Length => Math.Abs(x) + Math.Abs(y) + Math.Abs(z);
        ...
        public readonly LongPoint3D AxisStep
        {
            get
            {
                if (x == 0 && y == 0 && z == 0)
        ...
        public static implicit operator (long x, long y, long z)(in LongPoint3D point) =>
